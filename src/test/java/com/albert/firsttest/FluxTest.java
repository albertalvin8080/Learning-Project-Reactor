...
public class FluxTest
{
    ...
    @Test
    public void Flux_BackpressureWithCustomSubscriber() {
    ...
    @Test
    public void Flux_BackpressureWithBaseSubscriber() {
        final Flux<Integer> flux = Flux.range(1, 10).log();
    ...
    @Test
    public void Flux_Interval_VirtualTime() {
...
//                .log()
    ...
    @Test
    public void ConnectableFlux_StepVerifier() throws InterruptedException {
    ...
    @Test
    public void ConnectableFlux_AutoConnect() {
        final Flux<Integer> flux = Flux.range(1, 5)
                .log()
                .limitRate(2)
                .publish()
